...
Sua tarefa é criar uma interface web que aceite upload do [arquivo CNAB](https://github.com/hudsonsza/teste-backend/blob/master/CNAB.txt), normalize os dados e armazene-os em um banco de dados relacional e exiba essas informações em tela.
...
4. Ser escrita na linguagem de sua preferência.
